...
from src.trajectoid import create_trajectoid_from_complex
...
x_dft, y_dft, z_dft = create_trajectoid_from_complex(filtered_dft)
x_dwt, y_dwt, z_dwt = create_trajectoid_from_complex(np.concatenate(filtered_dwt))  # flatten coeffs list
