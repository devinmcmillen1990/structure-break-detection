...
ax.plot(x_dft, y_dft, z_dft, label='DFT Trajectory', color='blue')
ax.plot(x_dwt, y_dwt, z_dwt, label='DWT Trajectory', color='orange')

# Set labels and legend
ax.set_xlabel('Index / Time')
ax.set_ylabel('Normalized Magnitude')
ax.set_zlabel('Phase')
ax.set_title('Overlay: DFT vs DWT Trajectory')
ax.legend()
